...
function Page() {
  return (
    <PortalLayout>
      <div className="mb-6">
        <h1 className="font-display text-3xl font-extrabold flex items-center gap-3"><ArrowLeftRight className="h-7 w-7 text-primary" /> Transfer of Funds</h1>
        <p className="text-sm text-muted-foreground mt-1">Internal transfers, MPESA, utility payments.</p>
      </div>
