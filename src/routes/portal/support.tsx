...
export const Route = createFileRoute("/portal/support")({
  head: () => ({ meta: [{ title: "Support & Help — NSSF SACCO Portal" }] }),
  component: Page,
});
...
function Page() {
  return (
    <PortalLayout>
      <div className="mb-6">
        <h1 className="font-display text-3xl font-extrabold flex items-center gap-3"><LifeBuoy className="h-7 w-7 text-primary" /> Support & Help</h1>
        <p className="text-sm text-muted-foreground mt-1">Tickets, chat and FAQs.</p>
      </div>
