...
function Page() {
  return (
    <PortalLayout>
      <div className="mb-6">
        <h1 className="font-display text-3xl font-extrabold flex items-center gap-3"><HandCoins className="h-7 w-7 text-primary" /> Loans</h1>
        <p className="text-sm text-muted-foreground mt-1">Apply, calculator, guarantors, repayment schedules.</p>
      </div>
