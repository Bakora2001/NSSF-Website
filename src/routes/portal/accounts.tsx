...
function Page() {
  return (
    <PortalLayout>
      <div className="mb-6">
        <h1 className="font-display text-3xl font-extrabold flex items-center gap-3"><Wallet className="h-7 w-7 text-primary" /> Accounts</h1>
        <p className="text-sm text-muted-foreground mt-1">FOSA accounts, transactions and statements.</p>
      </div>
